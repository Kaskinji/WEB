  ...
  <body>
    <div class= "main">
        ...
        <div class= "navigation_menu">
          <div class= "escape"><img src= "static/images/Escape-up.svg"></div>                 
            <ul class= "navigation-menu-elements">   
              ...
              <li class= "elementsOfMenu">about</li>
              <li class= "elementsOfMenu">contact</li> 
            </ul> 
        </div>
      ...
      <div class= "main-image">
        <img src= "WEB/images/IMAGE.jpg" alt= "main-image">
      </div>    
      ...
      <footer class= "footer">
        <div class= "footer-menu">
          <div class= "navigation_menu">
            <div class= "escape-footer"><img src= "WEB/images/Escape-white.svg"></div>              
